...
L'obiettivo è prendere l'applicazione presente nel **branch stage/local-docker** e trasformare l'applicazione in modo che sia portabile, isolata e facilmente scalabile  attraverso l'uso di **Docker** e **Docker Compose**. Il sistema è stato suddiviso in tre micro-servizi indipendenti:
