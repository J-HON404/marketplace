...
Per permettere al frontend di comunicare con il backend, per mezzo del suo hostname container, senza incorrere in problemi di CORS, Nginx è configurato come Reverse Proxy:
